...
@section('title', 'Edit Siswa — PAUD KB Pelangi')
...
.card-header h3 { font-size: 14px; font-weight: 500; color: var(--t1); }

/* ── Edit badge di header ── */
.edit-badge {
    margin-left: auto;
...
@media (prefers-color-scheme: dark) { .edit-badge { color: #FCD34D; } }
...
.f-input.err, .f-select.err, .f-textarea.err { border-color: var(--danger); }
.f-input.err:focus, .f-select.err:focus { box-shadow: 0 0 0 3px rgba(239,68,68,0.10); }
...
.tab-btn.active { color: var(--blue); font-weight: 500; border-bottom-color: var(--blue); }
...
/* ── Breadcrumb ── */
.breadcrumb { display: flex; align-items: center; gap: 6px; font-size: 13px; color: var(--t3); }
...
<div style="max-width:760px;margin:0 auto" class="space-y-4">
    ...
    <form method="POST" action="{{ route('siswa.update', $siswa) }}"
          enctype="multipart/form-data" x-data="formSiswa()">
        @csrf
        @method('PUT')
            ...
            <div style="padding:20px;display:flex;flex-direction:column;gap:18px">
                ...
                <div style="display:flex;gap:20px;align-items:flex-start;flex-wrap:wrap">
                    ...
                    <div style="flex-shrink:0">
                        <label>
                            <div class="foto-wrap">
                                {{-- Preview baru dari JS --}}
                                <template x-if="fotoPreview">
                                    <img :src="fotoPreview" alt="Preview foto baru">
                                </template>
                            ...
                            <span class="foto-label">Ganti foto</span>
                ...
                <div>
                    ...
                    <textarea name="alamat" rows="2"
                              ...
                              class="f-textarea">{{ old('alamat', $siswa->alamat) }}</textarea>
                </div>
            </div>
        </div>
        ...
        <div style="display:flex;align-items:center;justify-content:flex-end;gap:10px;margin-top:14px;padding-bottom:8px">
            <a href="{{ route('siswa.show', $siswa) }}" class="btn-cancel">Batal</a>
...
/* ── Restore tab jika ada old() error ── */
